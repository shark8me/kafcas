 ...
 *
 * Note that this is "borrowed" from the Spark sources, since this is a private
 * class and the Spark developers declined to make this public and usable by others,
 * discussion noted in this JIRA ticket
 * https://issues.apache.org/jira/browse/SPARK-1022
 */
